...
js_files = ['main.js', 'prep.js', 'course.js', 'complete.js', 'dictionary.js', 'specialty.js', 'qbank.js', 'tests.js', 'flashcards.js', 'drugs.js', 'cheatsheets.js', 'careplans.js', 'labvalues.js', 'mnemonics.js', 'patho.js', 'topics.js', 'studyplan.js']
inlined_js = []
for jf in js_files:
